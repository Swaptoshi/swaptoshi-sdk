import { Uint160String, Int24String, Uint16String, Uint8String, Uint128String, Uint32String, Int56String, Uint256, Uint32 } from '@dist/stores/library/int';
import { Observation } from '@dist/types';
