...
import { GovernableConfigRegistry } from '@swaptoshi/governance-module/dist/registry';
import { BaseGovernableConfig, GovernanceMethod, ProposalStoreData } from '@swaptoshi/governance-module';
